...
static GenOpFunc *gen_op_argos_clean_reg[CPU_NB_REGS] =
{
	gen_op_argos_clean_EAX,
	gen_op_argos_clean_ECX,
	gen_op_argos_clean_EDX,
	gen_op_argos_clean_EBX,
	gen_op_argos_clean_ESP,
	gen_op_argos_clean_EBP,
	gen_op_argos_clean_ESI,
	gen_op_argos_clean_EDI,
#ifdef TARGET_X86_64
	gen_op_argos_clean_R8,
	gen_op_argos_clean_R9,
	gen_op_argos_clean_R10,
	gen_op_argos_clean_R11,
	gen_op_argos_clean_R12,
	gen_op_argos_clean_R13,
	gen_op_argos_clean_R14,
	gen_op_argos_clean_R15,
#endif
};
 ...
 reswitch:
    ...
    case 0x38 ... 0x3d:
        {
            ...
            case 0: /* OP Ev, Gv */
                ...
                xor_zero:
                    ...
                    gen_op_update1_cc();
                    break;
		} else if (op == OP_SBBL && rm == reg) {
		sbb_zero:
                    /* sbb reg, reg optimisation */
                    gen_op_mov_TN_reg[ot][1][reg]();
                    gen_op(s, op, ot, rm); 
		    gen_op_argos_clean_reg[rm]();
                    break;
		} else if (op == OP_SUBL && rm == reg) {
		sub_zero:
                    /* sub reg, reg optimisation */
                    gen_op_movl_T0_0();
    ...
    case 0xff: /* GRP5 */
        ...
        case 2: /* call Ev */
            ...
            gen_push_T1(s);
#ifdef ARGOS_WHITELIST
	    if (in_argos_whitelist(ARGOS_WHITELIST_CALL, pc_start)) { 
		    gen_op_jmp_T0();
	    } else 
#else
	    {
		    gen_op_argos_save_EIP_im(pc_start);
		    gen_op_argos_call_jmp_T0();
	    }
#endif
            gen_eob(s);
            break;
        ...
        case 4: /* jmp Ev */
            if (s->dflag == 0)
                gen_op_andl_T0_ffff();
#ifdef ARGOS_WHITELIST
	    if (in_argos_whitelist(ARGOS_WHITELIST_JMP, pc_start)) {
		    gen_op_jmp_T0();
	    } else 
#else
	    {
    ...
    case 0xc2: /* ret im */
        ...
        if (s->dflag == 0)
            gen_op_andl_T0_ffff(); 
#ifdef ARGOS_WHITELIST
	if (in_argos_whitelist(ARGOS_WHITELIST_RET, pc_start)) { 
		gen_op_jmp_T0();
	} else 
#else
	{
		gen_op_argos_save_EIP_im(pc_start);
		gen_op_argos_ret_jmp_T0();
	}
#endif
        gen_eob(s);
        break;
