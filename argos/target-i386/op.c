...
{
    T0 += T1;
    ARGOS_REG_ADD(T0TAG, T1TAG);
}

void OPPROTO op_orl_T0_T1(void)
{
    T0 |= T1;
    ARGOS_REG_OR(T0TAG, T1TAG);
}

void OPPROTO op_andl_T0_T1(void)
{
    T0 &= T1;
    ARGOS_REG_AND(T0TAG, T1TAG);
}

void OPPROTO op_subl_T0_T1(void)
{
    T0 -= T1;
    ARGOS_REG_SUB(T0TAG, T1TAG);
}

void OPPROTO op_xorl_T0_T1(void)
{
    T0 ^= T1;
    ARGOS_REG_XOR(T0TAG, T1TAG);
}
...
void OPPROTO op_mulw_AX_T0(void)
{
    ...
    CC_DST = res;
    CC_SRC = res >> 16;
    ARGOS_REG_MULw(EAXTAG, EDXTAG, T0TAG);
}
...
void OPPROTO op_mull_EAX_T0(void)
{
    ...
    ARGOS_REG_MULl(EAXTAG, EDXTAG, T0TAG);
}
...
void OPPROTO op_divw_AX_T0(void)
{
    ...
    EAX = (EAX & ~0xffff) | q;
    EDX = (EDX & ~0xffff) | r;
    ARGOS_REG_DIVw(EAXTAG, EDXTAG, T0TAG);
}
...
{
    T0 += PARAM1;
    ARGOS_REG_ADDIM(T0TAG);
}

void OPPROTO op_andl_T0_ffff(void)
{
    T0 = T0 & 0xffff;
    ARGOS_REG_ANDffff(T0TAG);
}

void OPPROTO op_andl_T0_im(void)
{
    T0 = T0 & PARAM1;
    ARGOS_REG_ANDIM(T0TAG, PARAM1);
}

void OPPROTO op_movl_T0_T1(void)
{
    T0 = T1;
    ARGOS_REG_MOV(T0TAG, T1TAG);
}

void OPPROTO op_movl_T1_imu(void)
{
    T1 = (uint32_t)PARAM1;
    ARGOS_REG_MOVIMl(T1TAG);
}
...
{
    T1 += PARAM1;
    ARGOS_REG_ADDIM(T1TAG);
}

void OPPROTO op_movl_T1_A0(void)
{
    T1 = A0;
    ARGOS_REG_MOV(T1TAG, A0TAG);
}

void OPPROTO op_movl_A0_im(void)
{
    A0 = (uint32_t)PARAM1;
    ARGOS_REG_MOVIMl(A0TAG);
}

void OPPROTO op_addl_A0_im(void)
{
    A0 = (uint32_t)(A0 + PARAM1);
    ARGOS_REG_ADDIMl(A0TAG);
}

void OPPROTO op_movl_A0_seg(void)
{
    A0 = (uint32_t)*(target_ulong *)((char *)env + PARAM1);
    ARGOS_REG_MOVSEGl(A0TAG);
}

void OPPROTO op_addl_A0_seg(void)
{
    A0 = (uint32_t)(A0 + *(target_ulong *)((char *)env + PARAM1));
    ARGOS_REG_ADDSEGl(A0TAG);
}

void OPPROTO op_addl_A0_AL(void)
{
    A0 = (uint32_t)(A0 + (EAX & 0xff));
    ARGOS_REG_ADDl(A0TAG, EAXTAG);
}
...
{
    T0 = PARAMQ1;
    ARGOS_REG_MOVIM(T0TAG);
}

void OPPROTO op_movq_T1_im64(void)
{
    T1 = PARAMQ1;
    ARGOS_REG_MOVIM(T1TAG);
}
...
void OPPROTO op_movq_A0_seg(void)
{
    ...
    ARGOS_REG_MOVSEG(A0TAG);
}

void OPPROTO op_addq_A0_seg(void)
{
    A0 += *(target_ulong *)((char *)env + PARAM1);
    ARGOS_REG_ADDSEG(A0TAG);
}

void OPPROTO op_addq_A0_AL(void)
{
    A0 = (A0 + (EAX & 0xff));
    ARGOS_REG_ADD(A0TAG, EAXTAG);
}
...
{
    EIP = T0;
    //ARGOS_CHECK(T0, T0TAG, ARGOS_ALERT_CALL);
}
...
{
    T0 = (int32_t)T0;
    ARGOS_REG_CASTl(T0TAG);
}

void OPPROTO op_movslq_RAX_EAX(void)
{
    EAX = (int32_t)EAX;
    ARGOS_REG_CASTl(EAXTAG);
}
#endif
...
void OPPROTO op_movsbw_AX_AL(void)
{
    ...
    ARGOS_REG_MOVSbw(EAXTAG);
}

void OPPROTO op_movslq_EDX_EAX(void)
{
    EDX = (uint32_t)((int32_t)EAX >> 31);
    ARGOS_REG_MOVSlq(EDXTAG, EAXTAG);
}

void OPPROTO op_movswl_DX_AX(void)
{
    EDX = (EDX & ~0xffff) | (((int16_t)EAX >> 15) & 0xffff);
    ARGOS_REG_MOVSwl(EDXTAG, EAXTAG);
}
...
{
    EDX = (int64_t)EAX >> 63;
    ARGOS_REG_MOVSqo(EDXTAG, EAXTAG);
}
#endif
...
{
    ESI = (uint32_t)(ESI + T0);
    ARGOS_REG_ADDl(ESITAG, T0TAG);
}

void OPPROTO op_addw_ESI_T0(void)
{
    ESI = (ESI & ~0xffff) | ((ESI + T0) & 0xffff);
    ARGOS_REG_ADDw(ESITAG, T0TAG);
}

void OPPROTO op_addl_EDI_T0(void)
{
    EDI = (uint32_t)(EDI + T0);
    ARGOS_REG_ADDl(EDITAG, T0TAG);
}

void OPPROTO op_addw_EDI_T0(void)
{
    EDI = (EDI & ~0xffff) | ((EDI + T0) & 0xffff);
    ARGOS_REG_ADDw(EDITAG, T0TAG);
}

void OPPROTO op_decl_ECX(void)
{
    ECX = (uint32_t)(ECX - 1);
    ARGOS_REG_DECl(ECXTAG);
}

void OPPROTO op_decw_ECX(void)
{
    ECX = (ECX & ~0xffff) | ((ECX - 1) & 0xffff);
    ARGOS_REG_DECw(ECXTAG);
}
...
{
    ESI = (ESI + T0);
    ARGOS_REG_ADD(ESITAG, T0TAG);
}

void OPPROTO op_addq_EDI_T0(void)
{
    EDI = (EDI + T0);
    ARGOS_REG_ADD(EDITAG, T0TAG);
}

void OPPROTO op_decq_ECX(void)
{
    ECX--;
    ARGOS_REG_DEC(ECXTAG);
}
#endif
...
void op_addl_A0_SS(void)
{
    ...
    ARGOS_REG_ADDSSl(A0TAG);
}

void op_subl_A0_2(void)
{
    A0 = (uint32_t)(A0 - 2);
    ARGOS_REG_SUB2l(A0TAG);
}

void op_subl_A0_4(void)
{
    A0 = (uint32_t)(A0 - 4);
    ARGOS_REG_SUB4l(A0TAG);
}

void op_addl_ESP_4(void)
{
    ESP = (uint32_t)(ESP + 4);
    ARGOS_REG_ADD4l(ESPTAG);
}

void op_addl_ESP_2(void)
{
    ESP = (uint32_t)(ESP + 2);
    ARGOS_REG_ADD2l(ESPTAG);
}

void op_addw_ESP_4(void)
{
    ESP = (ESP & ~0xffff) | ((ESP + 4) & 0xffff);
    ARGOS_REG_ADD4w(ESPTAG);
}

void op_addw_ESP_2(void)
{
    ESP = (ESP & ~0xffff) | ((ESP + 2) & 0xffff);
    ARGOS_REG_ADD2w(ESPTAG);
}

void op_addl_ESP_im(void)
{
    ESP = (uint32_t)(ESP + PARAM1);
    ARGOS_REG_ADDIMl(ESPTAG);
}

void op_addw_ESP_im(void)
{
    ESP = (ESP & ~0xffff) | ((ESP + PARAM1) & 0xffff);
    ARGOS_REG_ADDIMw(ESPTAG);
}
...
{
    A0 -= 2;
    ARGOS_REG_SUB2(A0TAG);
}

void op_subq_A0_8(void)
{
    A0 -= 8;
    ARGOS_REG_SUB8(A0TAG);
}

void op_addq_ESP_8(void)
{
    ESP += 8;
    ARGOS_REG_ADD8(ESPTAG);
}

void op_addq_ESP_im(void)
{
    ESP += PARAM1;
    ARGOS_REG_ADDIM(ESPTAG);
}
#endif
...
void OPPROTO op_svm_check_intercept_io(void)
{
    ...
    /* PARAMQ1 = TYPE (0 = OUT, 1 = IN; 4 = STRING; 8 = REP)
       T0      = PORT
       T1      = next eip */
    argos_stq_phys(env->vm_vmcb + offsetof(struct vmcb, control.exit_info_2),
		    T1, T1TAG);
...
void OPPROTO op_movl_T0_env(void)
{
    ...
    ARGOS_MMX_MOVREGl(T0TAG, PARAM1);
}

void OPPROTO op_movl_env_T0(void)
{
    *(uint32_t *)((char *)env + PARAM1) = T0;
    ARGOS_MMX_MOVlREG(PARAM1, T0TAG);
}

void OPPROTO op_movl_env_T1(void)
{
    *(uint32_t *)((char *)env + PARAM1) = T1;
    ARGOS_MMX_MOVlREG(PARAM1, T1TAG);
}

void OPPROTO op_movtl_T0_env(void)
{
    T0 = *(target_ulong *)((char *)env + PARAM1);
    ARGOS_MMX_MOVREGtl(T0TAG, PARAM1);
}

void OPPROTO op_movtl_env_T0(void)
{
    *(target_ulong *)((char *)env + PARAM1) = T0;
    ARGOS_MMX_MOVtlREG(PARAM1, T0TAG);
}

void OPPROTO op_movtl_T1_env(void)
{
    T1 = *(target_ulong *)((char *)env + PARAM1);
    ARGOS_MMX_MOVREGtl(T1TAG, PARAM1);
}

void OPPROTO op_movtl_env_T1(void)
{
    *(target_ulong *)((char *)env + PARAM1) = T1;
    ARGOS_MMX_MOVtlREG(PARAM1, T1TAG);
}
